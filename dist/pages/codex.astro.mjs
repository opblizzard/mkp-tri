...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="min-h-screen bg-gradient-to-b from-blue-900 via-violet-900 to-slate-900 text-white flex items-center justify-center"> <div class="glass-layer w-full max-w-5xl mx-auto px-6 py-12 space-y-12"> ${renderComponent($$result, "Header", $$Header, {})} ${renderComponent($$result, "GlassPanel", $$GlassPanel, { "ariaLabel": "Codex Hero Panel", "className": "max-w-2xl mx-auto mt-24 mb-10 py-10 px-4 text-center" }, { "default": ($$result2) => renderTemplate` <h1 class="text-4xl font-bold text-codex-accent font-mono mb-2 drop-shadow-glow">Codex</h1> <p class="text-lg text-slate-200 font-mono mb-4">Ceremonial archive, protocol registry, and mythic memory for MKP-TRI. Inspect the cycles, entries, and timeline below.</p> ` })} ${renderComponent($$result, "GlassPanel", $$GlassPanel, { "ariaLabel": "Codex Timeline & Entries Panel", "className": "w-full max-w-4xl mx-auto px-2 mb-12 grid grid-cols-1 md:grid-cols-2 gap-8" }, { "default": ($$result2) => renderTemplate` ${renderComponent($$result2, "GlassPanel", $$GlassPanel, { "ariaLabel": "Codex Timeline", "className": "p-6" }, { "default": ($$result3) => renderTemplate` <h3 class="font-semibold mb-2 text-codex-accent font-mono text-lg">Codex Timeline</h3> ${renderComponent($$result3, "Timeline", $$Timeline, { "items": [
  ...
  ] })} ` })} ${renderComponent($$result2, "GlassPanel", $$GlassPanel, { "ariaLabel": "Codex Entries", "className": "p-6" }, { "default": ($$result3) => renderTemplate` <h3 class="font-semibold mb-2 text-codex-accent font-mono text-lg">Codex Entries</h3> ${entries.length === 0 ? renderTemplate`<p class="text-base text-slate-400 font-mono">No entries yet. The codex is waiting for its first inscription.</p>` : renderTemplate`<div class="space-y-3 sm:space-y-4"> ${entries.slice().sort((a, b) => a.timestamp < b.timestamp ? 1 : -1).map((entry) => renderTemplate`${renderComponent($$result3, "CodexEntry", $$CodexEntry, { ...entry })}`)} </div>`}` })} ` })} ${renderComponent($$result, "GlassPanel", $$GlassPanel, { "ariaLabel": "About Codex Panel", "className": "w-full max-w-3xl mx-auto px-2 mb-16" }, { "default": ($$result2) => renderTemplate` <h2 class="text-2xl font-bold text-codex-accent mb-4 font-mono">Why the Codex?</h2> <div class="text-slate-200 text-base leading-relaxed">
